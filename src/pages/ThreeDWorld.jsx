  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      ...
      <p className="mb-6 text-slate-600 dark:text-slate-400">
        Walk through a preview of the CDLC facility. Desktop: click the scene, then WASD or
        arrow keys to move and mouse to look around. Touch devices: drag to look around.
      </p>
